...
.navbar {
  ...
  padding: 0.5rem 1rem;
  /* Añade un padding de 0.5rem arriba y abajo, y 1rem a los lados */
  align-items: center;
...
.navbar-menu {
  ...
  /* Alinea los elementos al final de la navbar */
}
...
a {
  border: 1px solid;
  /* Añade un borde sólido de 1px */
  border-color: rgba(83, 88, 88, 0.774);
  border-radius: 5px;
  /* Redondea las esquinas del borde */
  text-decoration: none;
  /* Elimina el subrayado de los enlaces */
  transition: 0.4s;
  /* Añade una transición suave de 0.4s para los cambios de estilo */
  padding: 5px;
