...
public class MenuIngresar {
     ...
     */
    public MenuIngresar(BaseDeDatos baseDeDatos) {
    ...
    public void mostrarMenu() {
        ...
        Cliente nuevoCliente = new Cliente(documento, nombre, apellido, email, telefono, direccion, codigoPostal,
    ...
    // ... (Otros métodos se pueden agregar aquí si es necesario)
}
