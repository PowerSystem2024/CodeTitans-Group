...
const educacion = ref([
  ...
  {
    id: 2,
    titulo: 'iOS & Swift - The Complete iOS App Development Bootcamp',
    institucion: 'London App Brewery',
    fecha: '2023-2024',
  },
  {
    id: 3,
    titulo: 'Flutter Intermedio: Diseños profesionales y animaciones',
    institucion: 'DevTalles',
    fecha: '2024',
  },
  {
    id: 4,
    titulo: 'Flutter & Dart - The Complete Guide',
    institucion: 'Udemy',
    fecha: '2023',
  },
  {
    id: 5,
    titulo: 'The Complete Python Developer',
    institucion: 'Zero To Mastery',
    fecha: '2022',
  },
])
</script>
