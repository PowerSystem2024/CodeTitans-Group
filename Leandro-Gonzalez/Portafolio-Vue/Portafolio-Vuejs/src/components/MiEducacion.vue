...
import { ref } from 'vue'
const educacion = ref([
  { id: 1, titulo: 'Tecnico Universitario en Programacion', institucion: 'Universidad Tecnologica Nacional', fecha: '2024' },
  { id: 2, titulo: 'Desarrollo Web - Full Stack', institucion: 'DevSchool', fecha: '2023-2024' },
  { id: 3, titulo: 'Desarrollo de Aplicaciones Web', institucion: 'Open Boot Camp', fecha: '2023' },
  { id: 4, titulo: 'Desarrollo de Aplicaciones Moviles', institucion: 'Open Boot Camp', fecha: '2023' },
  { id: 5, titulo: 'Desarrollo de Aplicaciones Moviles', institucion: 'Open Boot Camp', fecha: '2023' }
...
<template>
  ...
  <section id="timeline">
    <ul class="line">
      <li v-for="edu in educacion" :key="edu.id">
        <div class="cont">
          <h3>{{ edu.titulo }}</h3>
          <p>
            {{ edu.institucion }}
    ...
    <p class="copy-right"> made by
      <a href="https://github.com/leanlag87">@leanlag87</a>
    </p>
  </section>
</template>
