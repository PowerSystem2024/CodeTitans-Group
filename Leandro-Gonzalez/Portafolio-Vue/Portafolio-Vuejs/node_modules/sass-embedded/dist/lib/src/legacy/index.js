...
function render(options, callback) {
    try {
        ...
        (0, deprecations_1.warnForHostSideDeprecation)('The legacy JS API is deprecated and will be removed in Dart Sass 2.0.0.', deprecations_1.deprecations['legacy-js-api'], options);
